...
alter table tag_product add constraint fk_tag_product_tag_01 foreign key (tag_id) references tag (id) on delete restrict on update restrict;

alter table tag_product add constraint fk_tag_product_product_02 foreign key (product_id) references product (id) on delete restrict on update restrict;
